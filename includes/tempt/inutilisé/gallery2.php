    ...
    <div class="portfolio-content">
        ...
        <ul class="portfolio-area">
            ...
            <li class="portfolio-item2" data-id="id-0" data-type="cat-item-4">
                <div>
                   <span class="image-block">
					<a class="image-zoom" href="./img/gallery/gallery_item_2.png" rel="prettyPhoto[gallery]" title="Wall-E"><img width="200" height="200" src="./img/gallery/gallery_item_2.png" alt="Wall-E" title="Wall-E" />
                    </a>
                    </span>
            ...
            <li class="portfolio-item2" data-id="id-1" data-type="cat-item-2">
                <div>
                   <span class="image-block">
					<a class="image-zoom" href="images/big/pic2.jpg" rel="prettyPhoto[gallery]" title="Up"><img width="225" height="140" src="./img/gallery/gallery_item_2.png" alt="Up" title="Up" />
                    </a>
                    </span>
                    <div class="home-portfolio-text">
